...
* If you are using **JavaScript** in your application, you can use our Chat Library for rapid deployment: [javascript-socket-api.md](javascript-socket-api.md "mention")
