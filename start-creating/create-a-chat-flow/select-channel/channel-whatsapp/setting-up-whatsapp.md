...
Click ![The upper right side of the screen of the Twilio homepage has "Start for Free" button that leads to the registration process.](<../../../../.gitbook/assets/image (6) (1) (1).png>) and follow the instructions to register a new account. You’ll need to provide your email address and set a password. Afterwards, you have to:
...
<figure><img src="../../../../.gitbook/assets/image (8) (1) (1).png" alt="The Twilio dashboard."><figcaption><p>The Twilio dashboard.</p></figcaption></figure>
...
1. Click ![The Messaging dropdown in the Twilio dashboard appears on the left-hand menu.](<../../../../.gitbook/assets/image (10) (1) (1).png>) in the left-hand menu.&#x20;
