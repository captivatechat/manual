...
2. **Choose your AI Chatbot:** In _Step 1: AI Chatbot,_ you can choose an existing AI Chatbot or make one from scratch.
3. **Choose your Channel:** In _Step 2: Channel_, you will choose a Channel where you want your AI Chatbot to appear. This will have different steps depending on the Channel chosen and have separate instructions how to set up your Chat Flow's public name and relevant connections.
4. **Choose your Live Chat service:** In _Step 3: Live Chats_, you will choose what Live Chat service your AI Chatbot will connect to if a customer asks for an agent from your team.&#x20;
