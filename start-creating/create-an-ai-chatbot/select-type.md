...
* Click ![Clicking "Back" in the "Customize Type" view will send users back to the "Select Type" page.](<../../.gitbook/assets/image (2) (1) (1).png>) to go to the main _**Select Type**_ page. Choose ![Clicking the "Next: Train Your Chatbot" button in the "Customize Type" view sends users to the "Train Your AI Chatbot" page.](<../../.gitbook/assets/image (269).png>) on the lower right-hand corner.
