...
<figure><img src="../../../.gitbook/assets/image (36).png" alt="After giving your AI Chatbot a name and logo, you will be taken to &#x22;Import Your Own Information.&#x22; This menu contains a list of resources you uploaded, and the option to upload new data."><figcaption><p>After giving your AI Chatbot a name and logo, you will be taken to "Import Your Own Information." This menu contains a list of resources you uploaded, and the option to upload new data.</p></figcaption></figure>
...
To visit the _Import Your Own Information_ page, you need to click the !["Add Information" button on the side bar leads to "Import Your Own Information" page](<../../../.gitbook/assets/image (1) (1).png>) button on the side bar of the AI Chatbot creation process.
