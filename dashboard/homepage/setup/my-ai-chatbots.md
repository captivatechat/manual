...
Click on ![The +AI Chatbot button in "My AI Chatbots" page can create a new Chatbot.](<../../../.gitbook/assets/image (260).png>) to add a new AI Chatbot.&#x20;

### AI Chatbot List

<figure><img src="../../../.gitbook/assets/image (10) (1) (1) (1) (1) (1) (1).png" alt="A list of AI Chatbots containing a unique title and icon. The selected AI Chatbot is in dark blue."><figcaption><p>A list of AI Chatbots containing a unique title and icon. The selected AI Chatbot is in dark blue.</p></figcaption></figure>
