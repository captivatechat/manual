...
<figure><img src="../../../.gitbook/assets/image (1).png" alt=""><figcaption><p>Accessing the "Referrals" tab can be done by clicking on the "Referrals" button on the lower-left side of the Captivate Chat internal dashboard, and when loading the settings after clicking any option (Edit Profile, Manage Plan, Account Details) from your profile icon on the upper-right side of the dashboard.</p></figcaption></figure>
